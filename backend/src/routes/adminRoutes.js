...
router.post("/products", upload.single("image"), adminController.createProductAdmin);
router.patch("/products/:productId", upload.single("image"), adminController.updateProductAdmin);
