...
export const getProductFallbackImage = (product) => {
  ...
  return encodeSvg(`
    <svg xmlns="http://www.w3.org/2000/svg" width="1200" height="800" viewBox="0 0 1200 800">
      ...
      <circle cx="190" cy="170" r="85" fill="#111111" opacity="0.12"/>
      <circle cx="1010" cy="610" r="120" fill="#111111" opacity="0.08"/>
      <rect x="110" y="145" rx="28" ry="28" width="980" height="510" fill="#ffffff" opacity="0.92"/>
      <text x="160" y="255" fill="#525252" font-family="Georgia, serif" font-size="34" letter-spacing="8">${category.toUpperCase()}</text>
      <text x="160" y="365" fill="#090909" font-family="Georgia, serif" font-size="62" font-weight="700">${title}</text>
      <text x="160" y="460" fill="#525252" font-family="Arial, sans-serif" font-size="34">Shuddh puja samagri for ghar aur mandir use</text>
      <text x="160" y="555" fill="#171717" font-family="Arial, sans-serif" font-size="30">DigiPandit Store</text>
    </svg>
  `);
};
