...
export default function UserBookingsPage() {
  ...
  return (
    <div className="rounded-[36px] bg-white p-8 shadow-soft">
      <p className="eyebrow">सेवा प्रबंधन</p>
      <h1 className="mt-2 text-4xl font-bold text-brand-ink">आपकी बुकिंग</h1>
      ...
      <div className="mt-8 space-y-4">
        ...
        {!bookings.length ? (
          <div className="rounded-[28px] border border-dashed border-brand-sand bg-brand-cream/60 p-10 text-center">
            <h2 className="text-2xl font-bold text-brand-ink">अभी कोई बुकिंग नहीं है</h2>
            <p className="mx-auto mt-3 max-w-md text-sm leading-7 text-brand-ink/65">पूजा, हवन या कथा के लिए अपने शहर में उपलब्ध सत्यापित पंडित देखें।</p>
            <Link to="/pandits" className="mt-6 inline-flex"><Button>पंडित सेवाएँ देखें</Button></Link>
          </div>
        ) : null}
      </div>
    </div>
