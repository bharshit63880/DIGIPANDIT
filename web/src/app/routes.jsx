...
const AstrologyHubPage = lazy(() => import("../pages/AstrologyHubPage"));
...
const HawanDetailPage = lazy(() => import("../pages/HawanDetailPage"));
...
const AdminHawanEditorPage = lazy(() => import("../pages/AdminHawanEditorPage"));
...
export const appRoutes = [
  {
    ...
    children: [
      ...
      { path: "/astrology", element: <AstrologyHubPage /> },
      { path: "/astrology/consultations", element: <AstrologyPage /> },
      { path: "/pandits", element: <PanditsPage /> },
      { path: "/pandits/:panditId", element: <PanditDetailPage /> },
      { path: "/kundali", element: <Navigate to="/astrology#kundali" replace /> },
      { path: "/hawan-guide", element: <HawanPage /> },
      { path: "/hawan-guide/:slug", element: <HawanDetailPage /> },
